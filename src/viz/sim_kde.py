# -*- coding: utf-8 -*-
"""
Functions for plotting simulated vs observed kernel density estimates.
"""
...
def plot_simulated_kdes(sim_y,
    ...
    bar_alpha : float in (0.0, 1.0), optional.
        ...
        simulations where no observations had `filter_idx == True` AND
        `sim_y == choice_condition`. Higher values lower the bar's
        transparency. `0` leads to an invisible bar. Default == 0.5.
    ...
    xlim, ylim : 2-tuple of ints or None, optional.
        Denotes the extents of the x-axis and y-axis, respectively, of the
        matplotlib Axes instance that are drawn. If None, the extent will not
        be manually altered from the matplotlib defaults. Default is None.
