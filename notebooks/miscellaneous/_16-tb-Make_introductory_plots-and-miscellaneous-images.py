...
# 4. Produce variations of the original 7 plots to further investigate the model.
# These exploratory plots will not be saved.
#
...
current_log_like_path = '../reports/figures/original_mnl_log_likelihood_plot_regcar.jpeg'
